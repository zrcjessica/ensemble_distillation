...
def main(args):
    ...
    for i in range(args.n_mods):
        ...
        if args.evoaug:
            ...
            model = utils.load_lentiMPRA_from_weights(weights=join(args.model_dir, str(i+1) + "_MPRAnn_finetune.h5"), 
            ...
            model = load_model(join(args.model_dir, str(i+1) + "_MPRAnn.h5"))
